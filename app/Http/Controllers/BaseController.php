...
class BaseController extends Controller
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function api_response_error($message, $error, int $response_code = 200, string $apiVersion = "1.0", string $type = "json", int $outputType = JSON_PRETTY_PRINT): JsonResponse
    {
        $status = $response_code;
        $response = "";
        $returnArr = [
